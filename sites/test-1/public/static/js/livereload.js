...
})()(
  {
                ...
                connected: function connected(protocol) {
                  ...
                  _this.log(
                    'LiveReload is connected to '
                      .concat(_this.options.host, ':')
                      .concat(_this.options.port, ' (protocol v')
                      .concat(protocol, ').')
                  )
                    ...
                    case 'cannot-connect':
                      return _this.log(
                        'LiveReload cannot connect to '
                          .concat(_this.options.host, ':')
                          .concat(_this.options.port, ', will retry in ')
                    ...
                    case 'broken':
                      return _this.log(
                        'LiveReload disconnected from '
                          .concat(_this.options.host, ':')
                          .concat(_this.options.port, ', reconnecting in ')
                          .concat(nextDelay, ' sec.')
                      )
          ...
          _createClass(Reloader, [
            ...
            },
            {
              ...
              value: function reloadImages(path) {
                ...
                if (this.document.styleSheets) {
                  return Array.from(this.document.styleSheets).map(function (
                    styleSheet
                  ) {
            ...
            },
            {
              ...
              value: function reloadStylesheetImages(
                ...
                for (
                  var _i4 = 0, _Array$from4 = Array.from(rules);
                  _i4 < _Array$from4.length;
                  _i4++
                ) {
            ...
            },
            {
              ...
              value: function reloadStylesheet(path) {
                ...
                for (
                  var _i7 = 0, _Array$from7 = Array.from(links);
                  _i7 < _Array$from7.length;
                  _i7++
                ) {
                ...
                if (match) {
                  ...
                  if (options.reloadMissingCSS) {
                    ...
                    for (
                      var _i9 = 0, _Array$from9 = Array.from(links);
                      _i9 < _Array$from9.length;
                      _i9++
                    ) {
            ...
            },
            {
              ...
              value: function reattachImportedRule(_ref) {
                ...
                var newRule = '@import url("'
                  .concat(href, '") ')
                  .concat(media, ';') // used to detect if reattachImportedRule has been called again on the same rule
    ...
    110: [
      function (require, module, exports) {
        ...
        var LiveReload = (window.LiveReload = new (require('./livereload').LiveReload)(
          window
        ))
