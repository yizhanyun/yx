$_mod.def("/marko$5.3.0/src/runtime/components/util-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$5.3.0/src/runtime/components/dom-data'/*"./dom-data"*/);
