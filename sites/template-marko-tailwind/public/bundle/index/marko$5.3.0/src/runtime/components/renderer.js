$_mod.def("/marko$5.3.0/src/runtime/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$5.3.0/src/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;

var ComponentsContext = require('/marko$5.3.0/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/);
...
var beginComponent = require('/marko$5.3.0/src/runtime/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$5.3.0/src/runtime/components/endComponent-browser'/*"./endComponent"*/);
